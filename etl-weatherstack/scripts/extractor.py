...
class WeatherstackExtractor:
    ...
    def extraer_clima(self, ciudad, reintento=True):
        ...
        try:
            ...
            if response.status_code == 429 and reintento:
                logger.warning(f"⏳ Límite alcanzado para {ciudad}, reintentando en 10s...")
                time.sleep(10)
                return self.extraer_clima(ciudad, reintento=False)
